...
function AboutMe() {
	...
	return (
		<div className="grid grid-flow-row place-items-center">
			...
			<div className="opacity-0 sm:opacity-100 vl"></div>
			<div
				ref={ref1}
			...
			>
				<div className="flex-1">
					<div className="m-5" style={getTheAnimationStyle(inView2, true)}>
						...
						<p className="text-xs sm:text-lg pt-8">
				...
				<div className="text-center flex-1">
					<div
						style={{
							...getTheAnimationStyle(inView2, false, 3),
							width: "100%",
						}}
					>
			...
			>
				<div className="flex-1">
					<div style={getTheAnimationStyle(inView3, true, 3)}>
				...
				<div className="flex-1">
					<div className="m-5" style={getTheAnimationStyle(inView4, true)}>
						...
						<p className="text-xs sm:text-lg pt-8">
							...
							Node.js to develop websites and mobile apps for the company.
						</p>
					</div>
				</div>
				<div className="text-center flex-1">
					<div
						style={{
							...getTheAnimationStyle(inView4, false, 3),
							width: "100%",
						}}
					>
